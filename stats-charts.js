        ...
        <div class="stats-grid">
            ...
            <div class="stat-card"><div class="stat-card-title">Resumen General</div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                    <div style="text-align:center;padding:14px;background:var(--bg);border-radius:8px"><div style="font-family:'Fraunces',serif;font-size:27px;font-weight:700">${subset.length}</div><div style="font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.8px;margin-top:2px">Búsquedas</div></div>
                    <div style="text-align:center;padding:14px;background:var(--bg);border-radius:8px"><div style="font-family:'Fraunces',serif;font-size:27px;font-weight:700;color:var(--green)">${subset.filter(b => b.status === 'Cerrada' || b.status === 'Finalizada').length}</div><div style="font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.8px;margin-top:2px">Cerradas/Fin.</div></div>
                    <div style="text-align:center;padding:14px;background:var(--bg);border-radius:8px"><div style="font-family:'Fraunces',serif;font-size:27px;font-weight:700;color:var(--blue)">${subset.filter(b => b.status === 'Proceso').length}</div><div style="font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.8px;margin-top:2px">En Proceso</div></div>
                    <div style="text-align:center;padding:14px;background:var(--bg);border-radius:8px"><div style="font-family:'Fraunces',serif;font-size:27px;font-weight:700;color:var(--orange)">${subset.reduce((a, b) => a + b.candidatos.length, 0)}</div><div style="font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.8px;margin-top:2px">Candidatos</div></div>
                    <div style="text-align:center;padding:14px;background:var(--bg);border-radius:8px"><div style="font-family:'Fraunces',serif;font-size:27px;font-weight:700;color:var(--blue)">${subset.reduce((a, b) => a + b.psicotecnicos.length, 0)}</div><div style="font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.8px;margin-top:2px">Psicotécnicos</div></div>
                </div>
            </div>
        </div>`;
}
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;flex-wrap:wrap">
                ...
                <div style="text-align:center;display:flex;flex-direction:column;justify-content:center;align-items:center">
                    ${conIngreso > 0 ? `<div style="position:relative;width:130px;height:130px"><canvas id="ch-permpct"></canvas>
                        <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-family:'Fraunces',serif;font-size:25px;font-weight:700;color:var(--accent-dark)">${tasaPermanencia}%</div>
                    </div>` : `<div style="font-family:'Fraunces',serif;font-size:39px;font-weight:700;color:var(--accent-dark)">${tasaPermanencia}%</div>`}
