...
function renderFichas() {
    ...
    unassignedCandidatos.forEach(c => cards.push({ c, b: null }));
...
function showView(v, btn) {
    ...
    if (v === 'pipeline' || v === 'choferes') {
        ...
        filteredIds = null;
        ['f-selector','f-tipo','f-depto','f-status','f-reabierta','f-alerta72','f-search','f-chofer-resultado'].forEach(fid => { const el = document.getElementById(fid); if (el) el.value = ''; });
        refreshView();
    }
